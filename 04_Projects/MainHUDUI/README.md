...
- Runtime glass composition preserves each PNG's source alpha, caps it with `Maximum Rendered Opacity`, and multiplies it by uGUI `Image.color.a`; panel/minimap, hotbar slot, and button caps are 0.13, 0.14, and 0.16 respectively.
