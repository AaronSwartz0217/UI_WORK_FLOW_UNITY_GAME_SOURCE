...
namespace LargeLoginUI
{
    ...
    /// character/equipment selection screen. A real account service can disable
    /// demo acceptance and call NotifyLoginSucceeded / NotifyLoginFailed.
    /// </summary>
    ...
    public sealed class LoginToCharacterFlowController : MonoBehaviour
    {
        ...
        {
            if (loginScreen == null || characterScreen == null ||
