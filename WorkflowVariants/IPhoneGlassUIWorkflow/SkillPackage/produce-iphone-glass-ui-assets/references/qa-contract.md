...
> Glass variant override: also read `glass-spec.md`. Intentional glass interior transparency is allowed only for components explicitly classified as glass; true Alpha outside the silhouette remains mandatory.
...
- `QA/GLASS_COLOR_QA.md`
- `QA/WIREFRAME_COLOR_MAP.json`
...
Glass projects additionally require the approved preset check, confirmed per-region wireframe colors, URP Shader assignment, and a white-model-color-to-generated-color comparison.
